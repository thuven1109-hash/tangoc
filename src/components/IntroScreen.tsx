...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onStart, onToggleSidebar, userProfiles }) => {
  ...
  const AVATAR_OPTIONS = [
    "https://lh3.googleusercontent.com/u/0/d/1AiMbjmCJUQyWPsWy1eImfz009oY4WEnf"
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onStart({
      name: name.trim(),
      appearance: appearance.trim() || "đương độ xuân thì trổ mã rực rỡ, mặn mà, vòng ngực thiếu nữ nảy nở. Trên người luôn phảng phất thứ mùi bột thơm đặc trưng.",
      personality: personality.trim(),
      age: 20,
      background: "Con gái út của lò bún lớn nhất nhì miệt rạch Vĩnh Long, sống sát vách nhà họ Tạ. Là thanh mai trúc mã từ nhỏ của {{char}}, luôn ra mặt bảo vệ và xem {{char}} như một 'người chị gái' hiền lành, ruột thịt. Đang bị tía má ép nhận trầu cau dạm ngõ đặng gả cho cậu ấm con Bá hộ giàu nứt đố đổ vách trong vùng."
    }, selectedAvatar);
  };
